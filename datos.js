const biblioteca = {
    "la-sombra": {
        titulo: "La Sombra (Archetypus)",
        breadcrumb: "Archivo / Psicología / Arquetipos",
        ...
        cuerpo: `
            <h2>Nigredo y el Descenso</h2>
            <hr>
            <p>En la alquimia psicológica, el encuentro con la sombra corresponde a la fase <em>Nigredo</em>. Es el momento de la "muerte negra", donde el alma debe enfrentarse a sus proyecciones.</p>
            <ul class="article-list">
                <li><strong>Identificar la Proyección:</strong> Lo que te irrita de otros es tu sombra.</li>
                <li><strong>Aceptación Radical:</strong> Reconocer nuestra dualidad.</li>
            </ul>
        `,
